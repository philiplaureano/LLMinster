...
const string HashesFilePath = "processed_gpt4_mini_hashes.json";
...
async Task Main()
{
    ...
    Console.WriteLine("Watching for new or changed .gpt4o-mini-q files. Press ENTER to exit.");
